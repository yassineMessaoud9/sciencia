...
class SimpleProductVariationResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'sku'                           => $this->sku,
            'stock'                         => floor($this->product?->show_stock_out == Activity::DISABLE ? $this->product?->can_purchasable == Ask::NO ? (int)env('NON_PURCHASE_QUANTITY') : (int)$this->stock_items_sum_quantity : 0),
        ];
    }
}
