    ...
    actions: {
        lists: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = "admin/delivery-boy/active-order";
                if (payload) {
        ...
        show: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/delivery-boy/active-order/show/${payload}`).then((res) => {
        ...
        changeStatus: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/delivery-boy/active-order/change-status/${payload.id}`).then((res) => {
                    context.commit('show', res.data.data);
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        export: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/delivery-boy/active-order/export';
                if (payload) {
                    url = url + appService.requestHandler(payload);
                }
