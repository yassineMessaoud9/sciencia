                        ...
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <label for="switch" class="custom-switch">
                                <label :for="notificationAlert.slug + notification.id" class="custom-switch"
                                    ...
                                    <input :id="notificationAlert.slug + notification.id" type="checkbox"
                                        :checked="notification.mail === enums.switchEnum.ON" :value="notification.mail"
                                        :name="notificationAlert.slug + notification.id">
                                    <span class="uppercase">
                                        {{ notification.mail === enums.switchEnum.ON ? $t('label.on') : $t('label.off')
                                        }}
                                    </span>
                                </label>
                            </label>
                    ...
                    <div class="col-12 xl:col-6" v-for="notification in notificationAlerts" :key="notification">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <div class="custom-switch">
                                ...
                                <span class="uppercase">
                                    {{ notification.sms === enums.switchEnum.ON ? $t('label.on') : $t('label.off')
                                    }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-12 xl:col-6" v-for="notification in notificationAlerts" :key="notification">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <div class="custom-switch">
                                ...
                                <span class="uppercase">
                                    {{ notification.push_notification === enums.switchEnum.ON ? $t('label.on') :
                                    $t('label.off') }}
                                </span>
                            </div>
                        </div>
