            ...
            <form @submit.prevent="save">
                <div class="form-row">
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="form.company_name" v-bind:class="errors.company_name ? 'invalid' : ''"
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="form.company_email" v-bind:class="errors.company_email ? 'invalid' : ''"
                            type="text" id="email" class="db-field-control" />
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="form.company_city" v-bind:class="errors.company_city ? 'invalid' : ''"
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="form.company_state" v-bind:class="errors.company_state ? 'invalid' : ''"
                            type="text" id="company_state" class="db-field-control" />
                    ...
                    <div class="form-row">
                        <div class="form-col-12 map-height">
                            <MapComponent v-if="isMap"
                                :location="{ lat: form.company_latitude, lng: form.company_longitude }"
                                :position="location" />
                        </div>
...
export default {
    ...
    methods: {
        ...
        add: function () {
            composables.openModal('companyMap');
        },
        location: function (e) {
            this.address = e.address;
            this.form.company_latitude = e.location.lat;
            this.form.company_longitude = e.location.lng;
            this.form.company_address = e.address;
        },
        mapReset: function () {
            this.isMap = false;
            composables.closeModal('companyMap');
