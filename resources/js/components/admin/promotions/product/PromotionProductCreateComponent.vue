<template>
    ...
    <button type="button" @click="add" data-modal="#addonModal"  class="h-8 px-3 flex items-center gap-2 text-xs tracking-wide capitalize rounded-md shadow text-white bg-primary">
