...
export default {
    name: "OrderHistoryShowComponent",
    components: {
        LoadingComponent,
    },
    data() {
    ...
    computed: {
        order: function () {
            return this.$store.getters['orderHistory/show'];
        },
        orderProducts: function () {
            return this.$store.getters['orderHistory/orderProducts'];
        },
        orderUser: function () {
            return this.$store.getters['orderHistory/orderUser'];
        },
        orderAddress: function () {
            return this.$store.getters['orderHistory/orderAddress'];
        },
        outletAddress: function () {
            return this.$store.getters['orderHistory/outletAddress'];
        },
    },
    mounted() {
        this.loading.isActive = true;
        this.$store.dispatch('orderHistory/show', this.$route.params.id).then(res => {
