<template>
    ...
    <div class="col-12" v-if="Object.entries(deliveryBoy).length > 0">
        ...
        <div class="flex flex-col items-start sm:flex-row sm:items-center gap-1.5 mb-6">
            ...
            <button type="button" @click="handleTab($event, 'statistics')"
                class="tab-button w-full justify-start sm:w-fit inline-flex items-center sm:justify-center gap-2 h-[38px] py-2 px-4 rounded-md text-[#6E7191] stroke-[#6E7191]">
                <i class="lab lab-line-items-report"></i>
                <span class="capitalize text-sm">{{ $t("button.statistics") }}</span>
            </button>
            ...
            <div class="db-card">
                ...
                <div class="db-card-body">
                    <div class="row py-2">
                        ...
                        <div class="col-12 sm:col-6 !py-1.5">
                            <div class="db-list-item p-0">
                                <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.delivery_zone') }}</span>
                                <span class="db-list-item-text w-full sm:w-1/2">{{ deliveryBoy.delivery_zone_name }}</span>
                            </div>
                        </div>
                        <div class="col-12 sm:col-6 !py-1.5">
                            <div class="db-list-item p-0">
        ...
        <div id="statistics" class="tab-content">
            <StatisticsComponent :props="$route.params.id" />
        </div>
...
import DeliveryBoyAddressList from "./address/DeliveryBoyAddressList.vue";
...
import StatisticsComponent from "./statistics/StatisticsComponent.vue";
