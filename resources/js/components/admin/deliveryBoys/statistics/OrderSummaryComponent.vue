            ...
            <div class="col-12">
                <div class="db-card">
                    ...
                    <div class="db-card-body">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-1 mt-5">
                            <apexchart height="250" class="mobile:w-fit mobile:mx-auto" v-if="options"
...
export default {
    ...
    methods: {
        orderSummary: function (e) {
            ...
            this.$store.dispatch("deliveryBoyOrder/orderSummary", date).then((res) => {
