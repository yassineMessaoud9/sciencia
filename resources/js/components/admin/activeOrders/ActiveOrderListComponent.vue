<template>
    ...
    <div class="col-12">
        <div class="db-card">
            <div class="db-card-header border-none">
                ...
                <div class="db-card-filter">
                    <TableLimitComponent @click.prevent="handlePaper" :method="list" :search="props.search"
                        :page="paginationPage" />
                    <FilterComponent @click.prevent="handleSlide('active-order-filter')" />
            ...
            <div class="table-filter-div" id="active-order-filter">
...
export default {
    ...
    computed: {
        orders: function () {
            return this.$store.getters['activeOrder/lists'];
        },
        customers: function () {
            return this.$store.getters['user/lists'];
        },
        pagination: function () {
            return this.$store.getters['activeOrder/pagination'];
        },
        paginationPage: function () {
            return this.$store.getters['activeOrder/page'];
        }
    },
    mounted() {
        this.list();
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch('activeOrder/lists', this.props.search).then(res => {
        ...
        xls: function () {
            this.loading.isActive = true;
            this.$store.dispatch("activeOrder/export", this.props.search).then((res) => {
                this.loading.isActive = false;
